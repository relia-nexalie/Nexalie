		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">July 13,2022 <span class="changelog-version">Lite Version 5.1.1</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Zero Widget Used Notice in Widget Scanner','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Elementor Backend CSS & JS Loading Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Age Gate : Body Overflow Scroll JS Improvement','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
