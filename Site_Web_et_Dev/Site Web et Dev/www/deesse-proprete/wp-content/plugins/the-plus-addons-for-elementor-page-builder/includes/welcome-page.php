		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">July 20,2022 <span class="changelog-version">Lite Version 5.1.2</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Added : Blockquote : Author Description option','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Blockquote : Quote Icon and position dynamic option','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Blockquote : Quote Image option','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
