...
const PRICES = {
  ...
  af: { vitrine: "600 — 1 000€", onepage: "200 — 350€", ecommerce: "1 200 — 2 000€", logo: "300 — 600€", identite: "600 — 1 200€", maintenance: "50 — 80€/mois" }
};
...
function HomePage({ setPage }) {
  ...
  const OFFERS = [
    { emoji: "🌱", name: "Pack Démarrage", price: "400€/mois", level: "Score 0–19", color: t.accent },
    { emoji: "🌿", name: "Pack Transformation", price: "600€/mois", level: "Score 20–39", color: t.gold },
    { emoji: "🌳", name: "Pack Auto. IA", price: "800€/mois", level: "Score 40–59", color: "#7B5EA7", badge: "POPULAIRE" },
    { emoji: "🚀", name: "Pack Excellence", price: "1 200€/mois", level: "Score 60–79", color: "#C0627A" },
  ];
...
function OffersPage({ setPage }) {
  ...
  const offers = [
    ...
    { emoji: "🌿", name: "Pack Transformation", audit: "700€", monthly: "600€/mois", min: "6 mois", score: "20–39", color: t.gold, items: ["Tout le Pack Démarrage", "2 sessions mensuelles (1h30 chacune)", "Stratégie digitale complète", "Formation équipe (2h/mois)", "Tableau de bord KPIs dédié"] },
    ...
    { emoji: "🚀", name: "Pack Excellence", audit: "1 500€", monthly: "1 200€/mois", min: "12 mois", score: "60–79", color: "#C0627A", items: ["Tout le Pack Automatisation", "Accompagnement stratégique avancé", "Présentiel possible (France/Congo)", "Sessions illimitées", "Réseau partenaires Nexalie"] },
  ];
  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "48px 24px" }}>
      ...
      <div style={{ padding: "24px", background: `${t.accent}06`, border: `1px solid ${t.accent}20`, borderRadius: "14px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
        ...
        <p style={{ fontFamily: "Georgia, serif", fontSize: "22px", color: t.accent }}>350€/personne</p>
      </div>
    </div>
  );
}
...
function ServicesPage({ setPage }) {
  ...
  const services = [
    ...
    { emoji: "🎯", name: "Landing Page", price: mode === "fr" ? "600 — 900€" : "300 — 500€", delay: "1 semaine", color: "#CE9178", badge: null, items: ["Design orienté conversion", "Formulaire de capture", "Analytics avancés", "CTA optimisés"] },
    ...
    { emoji: "🔄", name: "Refonte Site", price: mode === "fr" ? "800 — 1 500€" : "400 — 800€", delay: "2-3 semaines", color: "#569CD6", badge: null, items: ["Audit site existant", "Nouveau design moderne", "Migration contenus", "SEO optimisé"] },
    ...
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px", textAlign: "center" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr 1fr", gap: "14px", textAlign: "left" }}>
        {[
          ...
          { name: "Premium", price: billing === "annual" ? "20€" : "29€", period: "/mois", badge: "POPULAIRE", color: t.gold, items: ["Tous les outils illimités", "Business Plan IA", "Roadmap + Veille", "CDC + Budget", "Export PDF", "Support WhatsApp"], cta: "Passer Premium", ctaFilled: true, ctaAction: () => setPage("checkout") },
          { name: "Consulting", price: "400€+", period: "/mois", color: "#7B5EA7", items: ["Tout Premium inclus", "Sessions Zoom mensuelles", "Rapport personnalisé", "Roadmap sur mesure", "WhatsApp direct Relia"], cta: "Prendre RDV", ctaAction: () => setPage("contact") },
        ].map((plan, i) => (
