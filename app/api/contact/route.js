    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <body style="font-family: sans-serif; padding: 20px; color: #0F172A;">
          ...
          <p style="margin-top: 20px; font-size: 13px; color: #4B5563;">Reçu le ${new Date().toLocaleString('fr-FR')} · nexalie.co</p>
        </body></html>
      `,
    });
  } catch (err) {
        ...
        <body style="font-family: -apple-system, sans-serif; background: #F8FAFC;">
          <div style="max-width: 540px; margin: 40px auto; background: #fff; border-radius: 16px; overflow: hidden;">
            ...
            <div style="padding: 32px 36px;">
              <h2 style="font-size: 20px; font-weight: 300; color: #0F172A; margin-bottom: 14px;">
                Bonjour ${nom},
              </h2>
              <p style="font-size: 14px; color: #4B5563; line-height: 1.8; margin-bottom: 14px;">
                J'ai bien reçu votre demande concernant la solution marque blanche Nexalie. Je reviens vers vous <strong style="color: #0F172A;">sous 24h ouvrées</strong> pour un appel de découverte.
              </p>
              ...
              <div style="margin-top: 28px; padding-top: 20px; border-top: 1px solid #F3F4F6;">
                ...
                <p style="font-size: 13px; font-weight: 700; color: #0F172A; margin: 4px 0 0;">Rélia Ebiya — Fondatrice Nexalie</p>
              </div>
            </div>
          </div>
        </body></html>
