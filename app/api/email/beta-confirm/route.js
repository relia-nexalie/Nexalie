      ...
      html: `
        ...
        <body style="font-family: -apple-system, sans-serif; background: #F8FAFC;">
          <div style="max-width: 540px; margin: 40px auto; background: #fff; border-radius: 16px; overflow: hidden;">
            <div style="background: #0F172A; padding: 24px 36px; display: flex; align-items: center; gap: 8px;">
            ...
            <div style="padding: 36px;">
              ${isWaitlist ? `
                <h2 style="font-size: 22px; font-weight: 300; color: #0F172A; margin-bottom: 12px;">
              ...
              ` : `
                ...
                <div style="background: rgba(78,201,176,0.08); border: 2px solid #4EC9B0; border-radius: 12px; padding: 20px; text-align: center; margin: 20px 0;">
                  ...
                  <p style="font-size: 16px; font-weight: 700; color: #0F172A; margin: 0;">Accès Pro Nexalie — 3 mois offerts</p>
                  <p style="font-size: 12px; color: #4B5563; margin: 6px 0 0;">Roadmap IA · PDF · Certification · Nexalie OS illimité</p>
                </div>
                <p style="font-size: 14px; color: #4B5563; line-height: 1.8; margin-bottom: 14px;">
                  Je vous contacterai dans les <strong style="color: #0F172A;">48h</strong> pour planifier votre session d'onboarding personnalisée (30 min avec moi).
                </p>
                <p style="font-size: 14px; color: #4B5563; line-height: 1.8; margin-bottom: 24px;">
                ...
                <a href="${process.env.NEXT_PUBLIC_APP_URL}/audit" style="display: block; text-align: center; background: transparent; color: #0F172A; padding: 12px 28px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 14px; border: 2px solid #0F172A;">
              ...
              <div style="margin-top: 28px; padding-top: 20px; border-top: 1px solid #F3F4F6;">
                ...
                <p style="font-size: 13px; font-weight: 700; color: #0F172A; margin: 4px 0 2px;">Rélia Ebiya — Fondatrice Nexalie</p>
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; padding: 20px;">
          ...
          <p style="color: #4B5563; font-size: 12px;">nexalie.co · ${new Date().toLocaleString('fr-FR')}</p>
        </div>
      `,
    });
  } catch {}
